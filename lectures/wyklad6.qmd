...
CourseQuiz.mount(document.getElementById('rsod-quiz'), {
  course: "prba2026",
  lecture: "wyklad6",
  title: "Wykład 5: Jak uniknąć błędów w projektowaniu?",
  ...
  questions: [
    ...
    },
    {
      ...
      text: "Tabela KURS(KursID, Nazwa, Prowadzący, PokojProwadzącego) — pokój zależy od tego, KTO prowadzi, a nie bezpośrednio od KursID (KursID → Prowadzący → PokojProwadzącego). Jaką postać normalną narusza ta tabela i jak to naprawić?",
      options: [
